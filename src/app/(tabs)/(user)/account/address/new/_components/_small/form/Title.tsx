    ...
    return (
        <div>
            <div className="h-16 flex items-center relative">
                ...
                <input
                    id="title"
                    className={`w-full h-full pt-[1px] px-16 text-lg bg-white rounded-2xl text-neutral-700 placeholder:font-shabt placeholder:text-[.8rem] placeholder:text-neutral-400 border border-neutral-200 focus:border-blue-500 transition-all duration-500
