...
const Like = () => {
    ...
    const likequestion = useLikeQuestion(question._id, _id!);
    ...
    const handleLikeClick = async () => {
        ...
        await likequestion.mutateAsync();
    };
        ...
        <>
            <div className="flex items-center gap-1">
                <button
                    ...
                    className="gap-[2px]"
                    disabled={likequestion.isPending}
                >
                    {isLiked ? (
                        <svg
                ...
                <p className="mt-1 text-[.95rem] font-shabmt text-[#999] tracking-[1px]">
