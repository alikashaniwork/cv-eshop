...
const MainProduct = () => {
    ...
    const { specs } = product;
    return (
        <div className="border-l border-neutral-200 pt-4">
            <Image
                width={200}
                height={250}
                src={product?.cover[0] || ""}
            ...
            />
            <p className="mt-4 sticky top-0 bg-[#f5f5f755] backdrop-blur-xl w-full h-14 flex items-center justify-center text-center font-sft border-b border-neutral-200">
                {product?.name.en}
            </p>
            <div>
                <Part
