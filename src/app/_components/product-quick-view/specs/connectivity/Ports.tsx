...
const Ports = () => {
    ...
    const TitleContainer = ({ children }: PropsWithChildren) => (
        <div className="min-w-[100px] max-w-[100px] text-[.9rem] text-neutral-500 *:font-shabt">
            {children}
        </div>
    );
        ...
        ports?.isExists && (
            <Part>
                ...
                <Container>
                    ...
                    {ports?.audioJack && (
                        <div>
                            <div className="min-w-[150px] max-w-[150px] text-[.9rem] text-neutral-500 *:font-shabt">
