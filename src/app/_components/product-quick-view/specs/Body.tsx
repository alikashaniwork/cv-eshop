...
const Body = () => {
    ...
    const ValueContainer = ({ children }: PropsWithChildren) => (
        <div className="flex items-center gap-[6px] text-lg">{children}</div>
    );
                ...
                <Container>
                    ...
                    {(body?.materials?.front ||
                        ...
                        <div className="flex-col !items-start">
                            ...
                            <div className="px-1 w-full last:*:border-none *:py-2 *:w-full *:items-center *:justify-between *:border-b *:border-[#333] *:flex *:before:bg-[#444] *:before:border *:before:border-[#555] *:before:min-w-[8px] *:before:min-h-[8px] *:before:max-h-[8px] *:before:rounded-full *:before:mt-[1px]">
                                {body?.materials?.front && (
                                    <div>
                                        <p className="pr-2 min-w-[60px] text-sm text-[#aaa]">
                                            جلو
                                        </p>
